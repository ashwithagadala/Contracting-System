...
export class TenderService {
  ...
  getTenderWinner(address:string,tenderId:any): Observable<TenderResponse>{
    let queryParams = new HttpParams();
    queryParams = queryParams.append("address",address);
    queryParams = queryParams.append("tenderId",tenderId);
    return this.http.get<TenderResponse>(`${config.apiUrl}/tenders/winner`, {params:queryParams})
      .pipe(
        catchError(this.handleError)
      )
  }
